...
public class UsingRandomClass{
	public static void main(String[] args){
		...
		int genratedInt = random.nextInt();
		System.out.printf("The generated number is %d%n",Math.abs(genratedInt));
		...
		System.out.printf("The float point value is %f%n",Math.abs(decimalNumber));
	}
}